...
func GetPeopleERR(column string) PeopleERR {
	...
	case "mailing street", "mailing_street", "mailing address street", "mailing state", "mailing province":
		err.Address1 = 1
	case "city", "city ", "street city", "home city", "city_pr", "pa city", "current city", "parent city", "scity", "active city", "home mailing city", "address city", "city1", "city_name":
		err.City = 1
	...
	case "county":
		err.County = 1
	case "country", "country (blank for us)", "home_country", "home country", "address country", "address country name", "pa nation", "nation", "country description", "parent nation", "active country", "country description 4", "natn_desc1", "cntry", "perm cntry", "long desc":
		err.Country = 1
	case "address", "student address", "parent address", "home address", "permanent address":
		err.FullAddress = 1
	case "email", "student email", "email ", "email1", "email address", "stu_email", "student e mail", "studentemail", "student personal email address", "student emails", "student e-mail", "student personal email", "student email address", "email2", "email_address_2", "student school email", "naz_email", "student school email_1", "student school email_2", "email address:", "winthrop email", "e-mail", "student e- mail", "primary_email", "e-mail address", "permanent email":
		err.Email = 1
	case "par_email", "par_email1", "parent e-mail", "par email", "parent email", "parent email address", "par_email2", "father_email", "mother_email", "parent_1's email", "parent_2's email", "parent's e-mail address", "parent/guardian email address:", "parent/guardian email", "p1_email", "emergency contact email", "parent/guardian or spouse e-mail address":
		// err.Email = 1
		err.ParentEmail = 1
