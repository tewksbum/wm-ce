...
var reStartsWithPrefix = regexp.MustCompile(`^(?i)(mailing address |patronaddress.permanent address |patron.|person |mailing |active |home |student |permanent |current )(.+)$`)
