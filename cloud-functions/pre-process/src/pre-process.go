...
var reStartsWithPrefix = regexp.MustCompile(`^(?i)(mailing address |patronaddress.permanent address |studentaddress.permanent address |patron.|person |mailing |active |home |student |student. |permanent |perm_ |current |p)(.+)$`)
