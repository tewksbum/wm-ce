...
func TestProcessRequestPRODDONTUSETHISONEBYMISTAKE(t *testing.T) {
	json := `{
		"clientID": "wemade",
		"clientSecret": "cool_works",
		"targetType": "datastore",
